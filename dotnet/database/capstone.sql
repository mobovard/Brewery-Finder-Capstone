...
INSERT INTO users(username,password_hash,salt,user_role,first_name,last_name,email,DOB,active)
VALUES('christ','s/q71yQeDo2A3Gx1FrSrThAUYqA=','+4wB449eXoE=','Brewer','Chris','Templeton','loser@yahoo.com','01/19/1995',1);

INSERT INTO users(username,password_hash,salt,user_role,first_name,last_name,email,DOB,active)
VALUES('test','YhV94SHg0bgikouwOQFLg4404U4=','h5I+1EZqAog=','Admin','Test','Test','Test@email.com','01/19/1995',1);

INSERT INTO users(username,password_hash,salt,user_role,first_name,last_name,email,DOB,active)
VALUES('ratneshb','LuzmsyWVc5m7Y4ZyWNXnkSlEkVI=','fCRe2YcPIYw=','Brewer','ratnesh','bhattacharya','mrmr@email.com','01/19/1995',1);
...
INSERT INTO beers(name,description,img,abv,brewery_id,beer_type,active_beer)
VALUES('PsycHOPathy','Explore the blend of citrus, bright, and floral aromas. Additional citrus flavors follow alongside a smooth bitterness. It finishes with a medium body and a slightly sweet, malty backbone. Trust your senses.', 'https://beerconnoisseur.com/sites/default/files/styles/beer_page_245w/public/beer/psychopathy-by-madtree-brewing-co.jpg?itok=dTC5asrA',6.9,2,'IPA',1);
...
INSERT INTO ratings(title,rating,review,user_id,beer_id)
VALUES('A juicy ipa', 3,'Kinda whatever. Not bad but just doesn’t do a lot for me.', 6, 4)

INSERT INTO ratings(title,rating,review,user_id,beer_id)
VALUES('Peachy Goodness', 3,'The peach gets stronger with each sip.', 6, 3)

INSERT INTO ratings(title,rating,review,user_id,beer_id)
VALUES('Tasty fruit beer', 4,'very apricot, which always seems to be very difficult to pull off. Well done!', 6, 3)

INSERT INTO ratings(title,rating,review,user_id,beer_id)
VALUES('Breakfast beer? Or Dessert Beer?', 5,'Tastes like a breakfast beer with the tart blackberry flavor. Quenches your thirst and takes you on a delicious ride.', 6, 5)

INSERT INTO ratings(title,rating,review,user_id,beer_id)
VALUES('Bold flavor',4,'Wow. Make sure you get a buddy to drive you home after this one. The only knock is that you can taste the high ABV.', 6, 11)

INSERT INTO ratings(title,rating,review,user_id,beer_id)
VALUES('Very bitter strong taste',1,'Not really an IPA guy. Very bitter flavor and aftertaste.', 6, 16)

INSERT INTO ratings(title,rating,review,user_id,beer_id)
VALUES('Perfect for a summer day', 5,'Wow its better than I expected. Very sweet and refreshing', 6, 12)

INSERT INTO ratings(title,rating,review,user_id,beer_id)
VALUES('Not what I expected', 2,'It has a bit of a hop in all the wrong ways',6, 14)

INSERT INTO ratings(title,rating,review,user_id,beer_id)
VALUES('Didn''t hold up to expectations', 3,'Flavor were muted and flat, not the best beer ever', 6, 13)

INSERT INTO ratings(title,rating,review,user_id,beer_id)
VALUES('Suprised me flavorwise', 3,'Dark in color but yeasty flavor.', 6, 15)
